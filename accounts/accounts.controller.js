...
function register(req, res, next){
  ...
  accountService.register(req.body, req.get('origin'))
    .then(_ => res.json({ msg: 'registration succesful, please check your email'}))
    .catch(next)  
}
...
function forgotPassword(req, res, next){
  accountService.forgotPassword(req.body, req.get('origin'))
    .then(_ => res.json({ msg: 'Please check your email for password reset instructions'}))
    .catch(next)
}
...
function resetPassword(req, res, next){
  accountService.resetPassword(req.body)
    .then(_ => res.json({ msg: 'Password reset successful, you can now login'}))
    .catch(next)
}
